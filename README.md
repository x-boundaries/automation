...
- Member lookup bridge worker fixture, Gate 3B local bridge readiness, and Gate 4A manual handoff outputs: `C:\XB\autocount_outputs\review\member_lookup_bridge`
